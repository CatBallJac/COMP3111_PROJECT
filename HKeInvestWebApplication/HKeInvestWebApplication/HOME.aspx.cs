...
namespace HKeInvestWebApplication
{
    public partial class HOME : System.Web.UI.Page
    {
        ...
        {
            Server.Transfer("ClientOnly/Track.aspx", true);
        }

        protected void BuyAndSell_Click(object sender, EventArgs e)
        {
            Server.Transfer("ClientOnly/BuyAndSellOrder.aspx", true);
        }

        protected void Alert_Click(object sender, EventArgs e)
        {
            Server.Transfer("ClientOnly/SetAlert.aspx", true);
        }
