<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageAccountAndClientInfo.aspx.cs" Inherits="HKeInvestWebApplication.EmployeeOnly.ManageAccountAndClientInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-horizontal">
        <div class="form-group">
            <asp:Label runat="server" Text="Account Number: " CssClass="control-label col-md-2" />
            <div class="col-md-4">
                <asp:TextBox ID="AccountNumber" runat="server" CssClass="form-input" MaxLength="10" />
            </div>
            <asp:Button ID="get_btn" runat="server" Text="Get Info Form" OnClick="get_btn_Click" />
        </div>
        <p class="text-danger"><asp:Literal ID="ErrorMessage" runat="server"></asp:Literal></p>
        <div class="form-group" id="infoForm" runat="server" visible="false">
            <div class="form-group">
