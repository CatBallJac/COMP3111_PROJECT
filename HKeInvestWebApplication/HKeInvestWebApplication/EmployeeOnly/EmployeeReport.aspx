<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeReport.aspx.cs" Inherits="HKeInvestWebApplication.EmployeeOnly.EmployeeReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <div class="col-md-4">
        <asp:TextBox ID="txtAccountNumber" runat="server" CssClass="form-control" ValidationGroup="Page" MaxLength="10"></asp:TextBox>
        <asp:RequiredFieldValidator ControlToValidate="txtAccountNumber" CssClass="text-danger" Display="Dynamic" Text="*" EnableClientScript="false" runat="server" ErrorMessage="Account Number is required." ValidationGroup="Page"></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtAccountNumber" CssClass="text-danger" Display="Dynamic" EnableClientScript="False" ErrorMessage="The format of the account number  is invalid" ForeColor="Red" ValidationExpression="^[A-Z]{2}[0-9]{8}$">*</asp:RegularExpressionValidator>
        
        </div>
    </div>
    <div>
            <asp:Button ID="accountInput" runat="server" Text="search account" OnClick="accountInput_Click" />
    </div>
    ...
    <asp:GridView ID="gvSummary" runat="server" Visible="True" AutoGenerateColumns="False">
        <Columns>
            ...
            <asp:BoundField DataField="convertedValue" DataFormatString="{0:n2}" HeaderText="Converted Value" ReadOnly="True" Visible="false" SortExpression="convertedValue" />
