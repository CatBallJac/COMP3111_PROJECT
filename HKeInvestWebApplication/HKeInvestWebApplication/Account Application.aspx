...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div id="PrimaryClient" class="form-group">
	        ...
	        <div class="form-group">
		        <asp:Label runat="server" Text="First name:" CssClass="label-control col-md-2" AssociatedControlID="firstName"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="firstName" runat="server" CssClass="form-control" MaxLength="35" ValidationGroup="Page"></asp:TextBox>
		        ...
		        <asp:Label runat="server" AssociatedControlID="lastName" Text="Last name:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="lastName" runat="server"  CssClass="form-control" MaxLength="35" ValidationGroup="Page"></asp:TextBox>
            ...
            <div class="form-group">
		        <asp:Label AssociatedControlID="dateOfBirth" runat="server" Text="Date of birth (dd/mm/yyyy):" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="dateOfBirth" runat="server"  CssClass="form-control" MaxLength="10" ValidationGroup="Page"></asp:TextBox>
		        ...
		        <asp:Label runat="server" AssociatedControlID="email" Text="Email address:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="email" runat="server"  CssClass="form-control" MaxLength="30" TextMode="Email" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
		        <asp:Label runat="server" AssociatedControlID="building" Text="Building (if any):" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="building" runat="server"  CssClass="form-control" MaxLength="50" ValidationGroup="Page"></asp:TextBox>
		        </div>
	
		        <asp:Label runat="server" AssociatedControlID="street" Text="Street:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="street" runat="server"  CssClass="form-control" MaxLength="35" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
		        <asp:Label runat="server" AssociatedControlID="district" Text="District:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="district" runat="server"  CssClass="form-control" MaxLength="19" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
	        	<asp:Label ID="Label7" runat="server" AssociatedControlID="homePhone" Text="Home phone:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	    <asp:TextBox ID="homePhone" runat="server"  CssClass="form-control" MaxLength="8" TextMode="Phone" ValidationGroup="Page"></asp:TextBox>
	        	...
	        	<asp:Label ID="Label8" runat="server" AssociatedControlID="homeFax" Text="Home fax:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	    <asp:TextBox ID="homeFax" runat="server"  CssClass="form-control" MaxLength="8" TextMode="Phone" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
	        	<asp:Label ID="Label9" runat="server" AssociatedControlID="businessPhone" Text="Business phone:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	    <asp:TextBox ID="businessPhone" runat="server"  CssClass="form-control" MaxLength="8" TextMode="Phone" ValidationGroup="Page"></asp:TextBox>
		        ...
		        <asp:Label ID="Label10" runat="server" AssociatedControlID="mobilePhone" Text="Mobile phone:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	    <asp:TextBox ID="mobilePhone" runat="server"  CssClass="form-control" MaxLength="8" TextMode="Phone" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
	        	<asp:Label ID="Label11" runat="server" AssociatedControlID="citizenship" Text="Country of citizenship:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	    <asp:TextBox ID="citizenship" runat="server"  CssClass="form-control" MaxLength="70" ValidationGroup="Page"></asp:TextBox>
	        	...
	        	<asp:Label ID="Label12" runat="server" AssociatedControlID="legalResidence" Text="Country of legal residence:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	    <asp:TextBox ID="legalResidence" runat="server"  CssClass="form-control" MaxLength="70" ValidationGroup="Page"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:CheckBox AutoPostBack="true" ID="HKIDUsed" runat="server" Text="Do you use HKID for this application?" OnCheckedChanged="HKIDUsed_CheckedChanged" />

            </div>

	        <div class="form-group">
	        	<asp:Label ID="Label13" runat="server" AssociatedControlID="HKID" Text="HKID/passport number:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	            	<asp:TextBox ID="HKID" runat="server"  CssClass="form-control" MaxLength="8" ValidationGroup="Page"></asp:TextBox>
		        ...
		        <asp:Label ID="Label14" runat="server" AssociatedControlID="passportCountry" Text="Passport country of issue:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="passportCountry" runat="server"  CssClass="form-control" MaxLength="70" ValidationGroup="Page"></asp:TextBox>
        ...
        <div id="CoClient" class="form-group" runat="server" visible="false">
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="title2" runat="server">
                    <asp:ListItem Value="0">---Please Select Your Title---</asp:ListItem>
                    <asp:ListItem Value="Mr.">Mr.</asp:ListItem>
                    <asp:ListItem Value="Mrs.">Mrs.</asp:ListItem>
                    <asp:ListItem Value="Ms.">Ms.</asp:ListItem>
	        ...
	        <div class="form-group">
		        <asp:Label ID="Label18" runat="server" Text="First name:" CssClass="label-control col-md-2" AssociatedControlID="firstName2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="firstName2" runat="server"  CssClass="form-control" MaxLength="35" ValidationGroup="Page"></asp:TextBox>
		        ...
		        <asp:Label ID="Label19" runat="server" AssociatedControlID="lastName2" Text="Last name:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="lastName2" runat="server"  CssClass="form-control" MaxLength="35" ValidationGroup="Page"></asp:TextBox>
            ...
            <div class="form-group">
		        <asp:Label ID="Label20" AssociatedControlID="dateOfBirth2" runat="server" Text="Date of birth (dd/mm/yyyy):" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="dateOfBirth2" runat="server"  CssClass="form-control" MaxLength="10" ValidationGroup="Page"></asp:TextBox>
		        ...
		        <asp:Label ID="Label21" runat="server" AssociatedControlID="email2" Text="Email address:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="email2" runat="server"  CssClass="form-control" MaxLength="30" TextMode="Email" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
                <asp:Label ID="Label22" runat="server" Text="Home address:" CssClass="label-control col-md-2" Font-Size="Medium"></asp:Label>
            </div>

	        <div class="form-group">
		        <asp:Label ID="Label23" runat="server" AssociatedControlID="building2" Text="Building (if any):" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="building2" runat="server"  CssClass="form-control" MaxLength="50" ValidationGroup="Page"></asp:TextBox>
		        </div>
	
		        <asp:Label ID="Label24" runat="server" AssociatedControlID="street2" Text="Street:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		            <asp:TextBox ID="street2" runat="server"  CssClass="form-control" MaxLength="35" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
		        <asp:Label ID="Label25" runat="server" AssociatedControlID="district2" Text="District:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		        <asp:TextBox ID="district2" runat="server"  CssClass="form-control" MaxLength="19" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
	        	<asp:Label ID="Label26" runat="server" AssociatedControlID="homePhone2" Text="Home phone:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	<asp:TextBox ID="homePhone2" runat="server"  CssClass="form-control" MaxLength="8" TextMode="Phone" ValidationGroup="Page"></asp:TextBox>
	        	...
	        	<asp:Label ID="Label27" runat="server" AssociatedControlID="homeFax2" Text="Home fax:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	<asp:TextBox ID="homeFax2" runat="server"  CssClass="form-control" MaxLength="8" TextMode="Phone" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
	        	<asp:Label ID="Label28" runat="server" AssociatedControlID="businessPhone2" Text="Business phone:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	<asp:TextBox ID="businessPhone2" runat="server"  CssClass="form-control" MaxLength="8" TextMode="Phone" ValidationGroup="Page"></asp:TextBox>
		        ...
		        <asp:Label ID="Label29" runat="server" AssociatedControlID="mobilePhone2" Text="Mobile phone:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	<asp:TextBox ID="mobilePhone2" runat="server"  CssClass="form-control" MaxLength="8" TextMode="Phone" ValidationGroup="Page"></asp:TextBox>
	        ...
	        <div class="form-group">
	        	<asp:Label ID="Label30" runat="server" AssociatedControlID="citizenship2" Text="Country of citizenship:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	<asp:TextBox ID="citizenship2" runat="server"  CssClass="form-control" MaxLength="70" ValidationGroup="Page"></asp:TextBox>
	        	...
	        	<asp:Label ID="Label31" runat="server" AssociatedControlID="legalResidence2" Text="Country of legal residence:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	        	<asp:TextBox ID="legalResidence2" runat="server"  CssClass="form-control" MaxLength="70" ValidationGroup="Page"></asp:TextBox>
            ...
            <div class="form-group">
                <asp:CheckBox ID="HKIDUsed2" runat="server" Text="Do you use HKID for this application?" AutoPostBack="True" OnCheckedChanged="HKIDUsed2_CheckedChanged" />
            </div>

	        <div class="form-group">
	        	<asp:Label ID="Label32" runat="server" AssociatedControlID="HKID2" Text="HKID/passport number:" CssClass="label-control col-md-2"></asp:Label>
	        	<div class="col-md-4">
	            	<asp:TextBox ID="HKID2" runat="server"  CssClass="form-control" MaxLength="8" ValidationGroup="Page"></asp:TextBox>
	        	    ...
	        	    <asp:RegularExpressionValidator ID="RegularExpressionValidator20" runat="server" CssClass="text-danger" Display="Dynamic" EnableClientScript="False" ErrorMessage="The format of HKID is invalid" ForeColor="Red" ValidationExpression="^[0-9A-Z]{8}$" ControlToValidate="HKID2"></asp:RegularExpressionValidator>
		        ...
		        <asp:Label ID="Label33" runat="server" AssociatedControlID="passportCountry2" Text="Passport country of issue:" CssClass="label-control col-md-2"></asp:Label>
		        <div class="col-md-4">
		        <asp:TextBox ID="passportCountry2" runat="server"  CssClass="form-control" MaxLength="70" ValidationGroup="Page"></asp:TextBox>
            ...
            <div class="form-group" id="PrimaryClientEmploymentInfo">
                <div class="col-md-offset-1">
                <h4>Primary Acccount Holder</h4>
                <div class="form-group">
                    <asp:Label ID="Label17" AssociatedControlID="employmentStatus" runat="server" Text="Employment status:" CssClass="label-control col-md-2"></asp:Label>
                ...
                <div class="form-group">
                    <asp:Label ID="Label34" runat="server" AssociatedControlID="occupation" Text="Specific occupation:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
		                <asp:TextBox ID="occupation" runat="server"  CssClass="form-control" MaxLength="20" ValidationGroup="Page"></asp:TextBox>
		            ...
		            <asp:Label ID="Label35" runat="server" AssociatedControlID="years" Text="Years with employer:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
		                <asp:TextBox ID="years" runat="server"  CssClass="form-control" MaxLength="2" TextMode="Number" ValidationGroup="Page"></asp:TextBox>
                ...
                <div class="form-group">
                    <asp:Label ID="Label36" runat="server" AssociatedControlID="employerName" Text="Employer name:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
		                <asp:TextBox ID="employerName" runat="server"  CssClass="form-control" MaxLength="25" ValidationGroup="Page"></asp:TextBox>
		            ...
		            <asp:Label ID="Label37" runat="server" AssociatedControlID="employerPhone" Text="Employer phone:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
		                <asp:TextBox ID="employerPhone" runat="server"  CssClass="form-control" MaxLength="8" TextMode="Phone" ValidationGroup="Page"></asp:TextBox>
                ...
                <div class="form-group">
                    <asp:Label ID="Label38" runat="server" AssociatedControlID="natureOfBusiness" Text="Nature of business:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
		                <asp:TextBox ID="natureOfBusiness" runat="server"  CssClass="form-control" MaxLength="20" ValidationGroup="Page"></asp:TextBox>
            ...
            <div class="form-group" id="CoClientEmploymentInfo" runat="server" visible="false">
                <div class="col-md-offset-1">
                <h4>Co-Acccount Holder</h4>
                <div class="form-group">
                    <asp:Label ID="Label39" AssociatedControlID="employmentStatus2" runat="server" Text="Employment status:" CssClass="label-control col-md-2"></asp:Label>
                ...
                <div class="form-group">
                    <asp:Label ID="Label40" runat="server" AssociatedControlID="occupation2" Text="Specific occupation:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
		                <asp:TextBox ID="occupation2" runat="server"  CssClass="form-control" MaxLength="20" ValidationGroup="Page"></asp:TextBox>
		            ...
		            <asp:Label ID="Label41" runat="server" AssociatedControlID="years2" Text="Years with employer:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
		                <asp:TextBox ID="years2" runat="server"  CssClass="form-control" MaxLength="2" TextMode="Number" ValidationGroup="Page"></asp:TextBox>
                ...
                <div class="form-group">
                    <asp:Label ID="Label42" runat="server" AssociatedControlID="employerName2" Text="Employer name:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
		                <asp:TextBox ID="employerName2" runat="server"  CssClass="form-control" MaxLength="25" ValidationGroup="Page"></asp:TextBox>
		            ...
		            <asp:Label ID="Label43" runat="server" AssociatedControlID="employerPhone2" Text="Employer phone:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
                ...
                <div class="form-group">
                    <asp:Label ID="Label44" runat="server" AssociatedControlID="natureOfBusiness2" Text="Nature of business:" CssClass="label-control col-md-2"></asp:Label>
		            <div class="col-md-4">
		                <asp:TextBox ID="natureOfBusiness2" runat="server"  CssClass="form-control" MaxLength="20" ValidationGroup="Page"></asp:TextBox>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <asp:TextBox ID="Part4Other" runat="server"  CssClass="form-control" MaxLength="30" ValidationGroup="Page"></asp:TextBox>
