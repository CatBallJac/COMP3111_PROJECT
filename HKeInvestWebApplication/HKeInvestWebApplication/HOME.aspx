...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:GridView ID="gvStock" runat="server" AutoGenerateColumns="false" Visible="false" OnSelectedIndexChanged="gvStock_SelectedIndexChanged" OnSorting="gvStock_Sorting">
            <Columns>
    ...
    <div>
        <asp:GridView ID="gvBond" runat="server" AutoGenerateColumns="false" Visible="false">
            <Columns>
                <asp:BoundField DataField="code" HeaderText="Code" ReadOnly="true" SortExpression="code" />
                <asp:BoundField DataField="name" HeaderText="Name" ReadOnly="true" SortExpression="name" />
                <asp:BoundField DataField="name" HeaderText="Name" ReadOnly="true" SortExpression="name" />
   ...
   <div>
        <asp:GridView ID="gvUnitTrust" runat="server" AutoGenerateColumns="false" Visible="false">
            <Columns>
                <asp:BoundField DataField="code" HeaderText="Code" ReadOnly="true" SortExpression="code" />
                <asp:BoundField DataField="name" HeaderText="Name" ReadOnly="true" SortExpression="name" />
                <asp:BoundField DataField="name" HeaderText="Name" ReadOnly="true" SortExpression="name" />
