...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div ID ="divCodeAndName" runat ="server" aria-dropeffect="link">
    ...
    <div id="divStockOrderDetail" runat="server" >
        ...
        <div id ="divLimitPirce" runat="server" visible ="false">
            ...
            <div>
                ...
                <asp:CustomValidator ID="cvLimitPrice" runat="server"  ControlToValidate="TextLimitPrice" CssClass="danger" OnServerValidate="cvLimitPrice_ServerValidate"></asp:CustomValidator>
        ...
        <div id ="divSellStockOrder" runat="server" visible ="false">
            ...
            <div>
                 ...
                 <asp:CustomValidator ID="cvSellShares" runat="server" ControlToValidate="TextSellShares" OnServerValidate="cvSellShares_ServerValidate" Display="Dynamic" EnableClientScript="False"></asp:CustomValidator>
    ...
    <div id ="divBondOrderDetail" runat="server" visible="false"> 
        ...
        <asp:Label ID="labelShares" runat="server" Text="# shares to sell"></asp:Label>
            ...
            &nbsp;<asp:CustomValidator ID="cvShares" runat="server"  ControlToValidate="TextShares" OnServerValidate="cvShares_ServerValidate" Display="Dynamic" EnableClientScript="False"></asp:CustomValidator>
