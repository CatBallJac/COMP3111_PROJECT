...
{
    public partial class ClientManageAccountAndClientInfo : System.Web.UI.Page
    {
        ...
        protected void loadPage()
        {
            ...
            string account_number = account.Rows[0].Field<string>("accountNumber").Trim();
        ...
        protected void updatePrimaryClient(string AN, SqlTransaction trans)
        {
            ...
            decimal year;decimal.TryParse(years, out year);
            years = year.ToString();
